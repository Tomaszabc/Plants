...
ActiveRecord::Schema[7.0].define(version: 2024_09_01_111511) do
  ...
  create_table "plants", force: :cascade do |t|
    ...
    t.text "note"
    t.integer "light_requirements"
    t.integer "water_needs"
    t.text "fertilization_needs"
    t.integer "toxicity"
  ...
  create_table "watering_logs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["plant_id"], name: "index_watering_logs_on_plant_id"
  end

  create_table "watering_reminders", force: :cascade do |t|
    t.integer "frequency"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
